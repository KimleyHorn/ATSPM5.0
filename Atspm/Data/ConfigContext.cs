        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            foreach (var entityType in modelBuilder.Model.GetEntityTypes())
            {
                if (typeof(IAuditProperties).IsAssignableFrom(entityType.ClrType))
                {
                    ...
                    builder.Property(nameof(IAuditProperties.Created))
                        .ValueGeneratedOnAdd()
                        .Metadata.SetAfterSaveBehavior(PropertySaveBehavior.Ignore);

                    builder.Property(nameof(IAuditProperties.CreatedBy))
                        .ValueGeneratedOnAdd()
                        .Metadata.SetAfterSaveBehavior(PropertySaveBehavior.Ignore);

                    // Modified fields: NOT database-generated
                    builder.Property(nameof(IAuditProperties.Modified))
                        .Metadata.SetAfterSaveBehavior(PropertySaveBehavior.Save);

                    builder.Property(nameof(IAuditProperties.ModifiedBy))
                        .Metadata.SetAfterSaveBehavior(PropertySaveBehavior.Save);
                }
            }
